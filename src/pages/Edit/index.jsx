        ...
        <Content>
          ...
          <Form>
            ...
            <InputWrapper>
              ...
              title="Preço"
              type="text"
              value={price ? `R$ ${price.replace('R$', '').trim()}` : ''}
              placeholder="R$ 00,00"
              onChange={(e) => setPrice(e.target.value.split('R$')[1].trim())}
            />
              </div>
            ...
            <button type="button" onClick={handleRemoveDish} disabled={loading}>
              {loading ? "Deletar pedido" : "Deletar pedido"}
            </button>
